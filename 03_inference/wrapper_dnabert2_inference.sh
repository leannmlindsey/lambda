...
output_dir=$lambda_dir/results/DNABERT2     # Place the full path to the results directory here
script_dir=$lambda_dir/03_inference     # Place the full path to the inference directory here
model_ckpt_dir=$lambda_dir/phage_finetuned_model_ckpts/DNABERT2
mkdir $output_dir
